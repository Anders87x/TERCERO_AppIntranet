<?php
    class svrrpt_retorno extends Conectar{

        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_retorno_01(
            ...
            $ssql_sentencia = "call apr_web_rpt_retorno_01a (?,?,?,?,?,?)";
        ...
        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_retorno_02(
            $psguia_numero_reporte
        ){
            $nhandle_conexion_bd = parent::_crear_conexion_bd();
            parent::set_names();

            $ssql_sentencia = "call apr_web_rpt_retorno_02a (?)";
            $ssql_objeto = $nhandle_conexion_bd->prepare($ssql_sentencia);
        ...
        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_retorno_03(
            $psguia_numero_pedido
        ){
            $nhandle_conexion_bd = parent::_crear_conexion_bd();
            parent::set_names();

            $ssql_sentencia = "call apr_web_rpt_retorno_03a (?)";
            $ssql_objeto = $nhandle_conexion_bd->prepare($ssql_sentencia);
