<?php
    class svrrpt_diario extends Conectar{

        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_diario_01(
            ...
            $ssql_sentencia = "call apr_web_rpt_diario_01a (?,?,?,?,?,?)";
        ...
        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_diario_02(
            $psguia_numero_reporte
        ){
            $nhandle_conexion_bd = parent::_crear_conexion_bd();
            parent::set_names();

            $ssql_sentencia = "call apr_web_rpt_diario_02a (?)";
            $ssql_objeto = $nhandle_conexion_bd->prepare($ssql_sentencia);
        ...
        /** METODO: OBTENER VISTA ******************************************/
        public function mdl_rpt_diario_03(
            $psguia_numero_pedido
        ){
            $nhandle_conexion_bd = parent::_crear_conexion_bd();
            parent::set_names();

            $ssql_sentencia = "call apr_web_rpt_diario_03a (?)";
            $ssql_objeto = $nhandle_conexion_bd->prepare($ssql_sentencia);
