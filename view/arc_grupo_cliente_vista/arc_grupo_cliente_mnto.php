			...
			<div class="modal-body">
				<div>
                    ...
                    <div class="form-group row m-b-15 align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control" maxlength="150" id="txtsgrupo_cliente_descripcion" name="txtsgrupo_cliente_descripcion" type="text" style="text-transform:uppercase;" placeholder="" data-parsley-required="true">
                        </div>
                    </div>
