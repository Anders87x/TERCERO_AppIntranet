...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Grupo de clientes</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Grupo de clientes</li>
			</ol>

            <h1 class="page-header">Grupo de clientes <small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">GRUPO DE CLIENTES</h4>
    ...
    <?php require_once("arc_grupo_cliente_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_grupo_cliente.js"></script>
