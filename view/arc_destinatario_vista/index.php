...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Destinatarios</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Destinatarios <small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">DESTINATARIOS</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <br></br>
                            <table id="grdregistro_vista_data" class="table table-striped table-bordered display nowrap" cellspacing="0" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>RAZON SOCIAL</th>
                                        <th>DIRECCION</th>
    ...
    <?php require_once("arc_destinatario_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_destinatario_vista.js"></script>
