...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Registro de precio</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Registro de precios <small></small></h1>
            
            <input type="hidden" id="txtstipo_documento_codigo" value="">
            <input type="hidden" id="txtsguia_serie" value="">
            <input type="hidden" id="txtsguia_correlativo" value="">

            <input type="hidden" id="hddscodigo_aleatorio" value="">
            <input type="hidden" id="hddssuperior_aleatorio" value="">
            <input type="hidden" id="hddscliente_codigo" value="">

            <input type="hidden" id="txtssuperior_aleatorio" value="">
            <input type="hidden" id="txtscliente_codigo" value="">
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">REGISTRO DE PRECIOS</h4>
                        ...
                        <ul class="nav nav-pills mb-2">
                            ...
                            <li class="nav-item">
                                <a href="#nav-pills-tab-1" data-toggle="tab" class="nav-link active">
                                    <span class="d-sm-none">BUSQUEDA POR REPORTE</span>
                                    <span class="d-sm-block d-none">BUSQUEDA POR REPORTE</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-row">
                                        <div class="col-xl-2">
                                            ...
                                            <input type="text" class="form-control" style="text-transform:uppercase;" maxlength="10"  id="pgrep_txtsguia_numero_reporte" name="pgrep_txtsguia_numero_reporte">
                                        </div>
                                    </div>
                            ...
                            <div class="row invoice">
                                <div class="row row-space-30 invoice-header">
                                    ...
                                    <div class="col-xl-4 invoice-date">
                                        ...
                                        <address class="m-t-5 m-b-5">
                                            <strong class="text-inverse" id="sguia_numero_completo"></strong><br>
                                            <p id="stipo_documento_descripcion"></p>
                                            <p id="scodigo_aleatorio"></p>
                                        </address>
                                    </div> 
                                            ...
                                            <table class="table">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-left bg-white" width="60%" id="sguia_fecha_vencimiento_texto"></th>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left bg-grey" width="40%">FECHA DE RETORNO LIMITE</th>
                                                        <th class="text-left bg-white" width="60%" id="sguia_fecha_retorno_texto"></th>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left bg-grey" width="40%">PRIORIDAD DE ATENCION</th>
                                                        <th class="text-left bg-white" width="60%" id="sprioridad_descripcion"></th>
                                                    </tr>
                                                </thead>
                                            </table> 
                                        </div>
                                            ...
                                            <div class="col-xl-12">
                                                <table class="table">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <th class="text-left bg-grey" width="40%">NOTA</th>
                                                            <th class="text-left bg-white" width="60%"></th>
                                                        </tr>
                                                    </thead>
                                                </table> 
                                            </div>
	...
	<script src="fin_precio_vista.js"></script>
