...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Reporte de documentos confirmados</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Reporte confirmaciones</li>
			</ol>

            <h1 class="page-header">Reporte de documentos confirmados<small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">REPORTE DE DOCUMENTOS CONFIRMADOS</h4>
...
<!--                             <li class="nav-item">
                            ...
                            <div class="tab-pane fade active show" id="nav-pills-tab-1">
                                <div class="panel-body">
                                    ...
                                    <div class="form-row align-items-right">
                                        ...
                                        <div class="col-xl-2">
                                            <button class="btn btn-primary waves-effect waves-light form-control" id="pgvar_btnbuscar">VISUALIZAR</button>
                                        </div>
                                        <div class="col-xl-2">
                        ...
                        <div class="panel-body">
                            <table id="grdconsulta_vista_data" class="display compact table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">OBSERVACION DE CONFIRMA</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="odd gradeX">
	...
	<script src="rpt_confirma.js"></script>
