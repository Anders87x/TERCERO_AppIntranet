<?php
    ...
    $psguia_numero_pedido = $_GET["psguia_numero_pedido"];

    $datos = $rptconfirma->mdl_rpt_confirma_03($psguia_numero_pedido);
        ...
        <Workbook xmlns='urn:schemas-microsoft-com:office:spreadsheet' 
            ...
            <Worksheet ss:Name='Hoja 1'>
                ...
                <Table x:FullColumns='1' x:FullRows='1' ss:DefaultRowHeight='15'>
                    ...
                    <Column ss:Index='09' ss:AutoFitWidth='0' ss:Width='100.00'/>
                    <Column ss:Index='10' ss:AutoFitWidth='0' ss:Width='200.00'/>
                    <Column ss:Index='11' ss:AutoFitWidth='0' ss:Width='50.00'/>
                    <Column ss:Index='12' ss:AutoFitWidth='0' ss:Width='70.00'/>
                    <Column ss:Index='13' ss:AutoFitWidth='0' ss:Width='150.00'/>
                    <Column ss:Index='14' ss:AutoFitWidth='0' ss:Width='150.00'/>
                    <Column ss:Index='15' ss:AutoFitWidth='0' ss:Width='65.00'/>
                    <Column ss:Index='16' ss:AutoFitWidth='0' ss:Width='65.00'/>
                    <Column ss:Index='17' ss:AutoFitWidth='0' ss:Width='50.00'/>
                    <Column ss:Index='18' ss:AutoFitWidth='0' ss:Width='100.00'/>
                    ...
                    <Row ss:AutoFitHeight='0' ss:Height='15.00'>
                        <Cell ss:StyleID='_sty_texWBL001'><Data ss:Type='String'>CLIENTE: </Data><NamedCell ss:Name='Print_Titles'/></Cell>
                    </Row>
                    <Row ss:AutoFitHeight='0' ss:Height='15.00'>
                    ...
                    <Row ss:AutoFitHeight='0' ss:Height='28.00'>
                        ...
                        <Cell ss:StyleID='_sty_sub01'><Data ss:Type='String'>TRANSVIAS</Data></Cell>
                        ...
                        <Cell ss:StyleID='_sty_sub01'><Data ss:Type='String'>AREA</Data></Cell>
                    ...
                    <Row ss:AutoFitHeight='0' ss:Height='15.00'>
                        ...
                        <Cell ss:StyleID='_sty_squWBL001'><Data ss:Type='String'>".$row['sremite_area_descripcion']."</Data></Cell>
                        ...
                        <Cell ss:StyleID='_sty_squWBL001'><Data ss:Type='String'>".$row['scliente_tipo_documento_codigo']."</Data></Cell>
                        <Cell ss:StyleID='_sty_squWBL001'><Data ss:Type='String'>".$row['scliente_documento_numero']."</Data></Cell>
                    </Row>
                    ";
                    }
                    $cadena_xml.="
