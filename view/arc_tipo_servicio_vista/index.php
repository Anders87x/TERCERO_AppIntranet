...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Tipo de servicio</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Tipo de servicio <small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">TIPO DE SERVICIO</h4>
    ...
    <?php require_once("arc_tipo_servicio_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_tipo_servicio.js"></script>
