...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Prioridad</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Prioridad</li>
			</ol>

            <h1 class="page-header">Prioridad <small></small></h1>
    ...
    <?php require_once("arc_prioridad_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_prioridad.js"></script>
