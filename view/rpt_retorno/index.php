...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Reporte de documentos retornados</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Reporte de retorrnados</li>
			</ol>

            <h1 class="page-header">Reporte retorno<small> de documentos devueltos por los representantes...<small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">REPORTE DE DOCUMENTOS RETORNADOS</h4>
