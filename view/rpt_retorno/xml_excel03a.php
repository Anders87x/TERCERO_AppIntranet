<?php
    ...
    $rptretorno = new svrrpt_retorno();

    $psguia_numero_pedido = $_GET["psguia_numero_pedido"];

    $datos = $rptretorno->mdl_rpt_retorno_03($psguia_numero_pedido);
        ...
        <Workbook xmlns='urn:schemas-microsoft-com:office:spreadsheet' 
            ...
            <Worksheet ss:Name='Hoja 1'>
                ...
                <Table x:FullColumns='1' x:FullRows='1' ss:DefaultRowHeight='15'>
                    ...
                    <Column ss:Index='11' ss:AutoFitWidth='0' ss:Width='70.00'/>
                    <Column ss:Index='12' ss:AutoFitWidth='0' ss:Width='150.00'/>
                    <Column ss:Index='13' ss:AutoFitWidth='0' ss:Width='30.00'/>
                    <Column ss:Index='14' ss:AutoFitWidth='0' ss:Width='100.00'/>

                    <Row ss:AutoFitHeight='0' ss:Height='20.00'>
                        <Cell ss:StyleID='_sty_rpt01'><Data ss:Type='String'>REPORTE DE DOCUMENTOS NO RETORNADOS Y RETORNADOS</Data><NamedCell ss:Name='Print_Titles'/></Cell>
                    </Row>
                    ...
                    <Row ss:AutoFitHeight='0' ss:Height='28.00'>
                        ...
                        <Cell ss:MergeAcross='1' ss:StyleID='_sty_sub01'><Data ss:Type='String'>DOCUMENTO DEL CLIENTE</Data></Cell>
                    </Row>
                    ";
