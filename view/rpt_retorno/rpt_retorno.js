...
$(document).on("click","#pgvar_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_retorno.php?caso=rpt_retorno_01',
            type : "post",
            dataType : "json",
            data:{
...
$(document).on("click","#pgrep_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_retorno.php?caso=rpt_retorno_02',
            type : "post",
            dataType : "json",
            data:{  
...
$(document).on("click","#pgped_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_retorno.php?caso=rpt_retorno_03',
            type : "post",
            dataType : "json",
            data:{  
