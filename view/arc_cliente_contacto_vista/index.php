...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Contacto(s) del cliente</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Contacto(s) del cliente</li>
			</ol>

            <h1 class="page-header">Contacto(s) del cliente <small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">CONTACTO(S) DEL CLIENTE</h4>
    ...
    <?php require_once("arc_cliente_contacto_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_cliente_contacto.js"></script>
