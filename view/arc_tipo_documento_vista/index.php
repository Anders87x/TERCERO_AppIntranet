...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Tipo de documento</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Tipo de documento <small></small></h1>
    ...
    <?php require_once("arc_tipo_documento_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_tipo_documento.js"></script>
