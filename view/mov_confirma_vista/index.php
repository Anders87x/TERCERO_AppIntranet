...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Confirmación de documento</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Registro de confirmaciones<small></small></h1>
            ...
            <div class="row">
				<div class="col-xl-3 col-md-3">
					<div class="widget widget-stats bg-blue">
						...
						<div class="stats-info">
							<h4>DOCUMENTOS SIN CONFIRMAR</h4>
							<p id='ntotal_transito'></p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;" id="btnntotal_transito">Ver listado <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-3">
					<div class="widget widget-stats bg-info">
						...
						<div class="stats-info">
							<h4>URGENTES SIN CONFIRMAR</h4>
							<p id='nurgente_transito'></p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;" id="btnnurgente_transito">Ver listado <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-3">
					<div class="widget widget-stats bg-orange">
						...
						<div class="stats-info">
							<h4>LICITACIONES SIN CONFIRMAR</h4>
							<p id='nlicitacion_transito'></p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;" id="btnnlicitacion_transito">Ver listado <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
            ...
            <div class="row">
				...
				<div class="col-xl-6">
					...
					<div class="panel panel-inverse" >
						<div class="panel-heading">
							<h4 class="panel-title">5 DESTINOS CON MAYOR DOCUMENTOS SIN CONFIRMAR</h4>
						...
						<div class="panel-body">
                            <table id="grdconfirma_resumen_05" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>AMBITO</th>
										<th>ORI</th>
				...
				<div class="col-xl-6">
					...
					<div class="panel panel-inverse" data-sortable-id="index-6">
						<div class="panel-heading">
							<h4 class="panel-title">5 DESTINOS CON MAYOR DOCUMENTOS URGENTES SIN CONFIRMAR </h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
						...
						<div class="panel-body">
                            <table id="grdconfirma_resumen_06" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>	
										<th>AMBITO</th>
										<th>ORI</th>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">CONFIRMACION DE DOCUMENTOS</h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
                        ...
                        <div class="tab-content p-15 rounded bg-white mb-4">
                            ...
                            <!-- end PAGE DOCUMENTO CLIENTE -->

                        </div>
                            
                        <!-- begin GRILLA CONFIRMA DOCUMENTOS -->
                        <div class="panel-body">
                            <table id="grdconfirma_vista_data" class="display compact table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>EST</th>
                                        <!-- <th>PRIOR</th> -->
                        ...
                        <!-- end GRILLA CONFIRMA DOCUMENTOS  -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row invoice">
                                <div class="row row-space-30 invoice-header">
                                    ...
                                    <div class="col-xl-4">
                                    <a href="javascript:void(0);" class="btn btn-primary m-r-5 m-b-5" id="btneditarremitente"> EDITAR</a>
