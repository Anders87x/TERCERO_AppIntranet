...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Tipo de transporte</title>
</head>
<body>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">TIPO DE TRANSPORTE</h4>
    ...
    <?php require_once("arc_tipo_transporte_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_tipo_transporte.js"></script>
