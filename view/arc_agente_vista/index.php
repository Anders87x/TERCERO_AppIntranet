...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Agentes</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Agentes <small></small></h1>
    ...
    <?php require_once("arc_agente_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_agente.js"></script>
