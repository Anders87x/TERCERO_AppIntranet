...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Consulta de documento</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
            ...
            <h1 class="page-header">Consulta completa de documentos<small></small></h1>
	...
	<script src="mov_consulta_vista.js"></script>
