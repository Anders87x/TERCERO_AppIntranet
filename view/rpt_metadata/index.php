...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Reporte metadata</li>
			</ol>

            <h1 class="page-header">Reporte metadata<small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">REPORTE DE METADATA</h4>
	...
	<script src="rpt_metadata.js"></script>
