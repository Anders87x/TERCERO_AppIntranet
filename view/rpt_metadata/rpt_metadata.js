...
$(document).on("click","#pgvar_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_diario.php?caso=rpt_diario_01',
            type : "post",
            dataType : "json",
            data:{
...
$(document).on("click","#pgrep_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_diario.php?caso=rpt_diario_02',
            type : "post",
            dataType : "json",
            data:{  
...
$(document).on("click","#pgped_btnbuscar", function(){
    ...
    tblconsulta_vista_data = $('#grdconsulta_vista_data').dataTable({
        ...
        ajax:{
            url: '../../controller/rpt_diario.php?caso=rpt_diario_03',
            type : "post",
            dataType : "json",
            data:{  
...
$(document).on("click","#pgped_btnexportar", function(){
    var lsguia_numero_pedido = $('#pgped_txtsguia_numero_pedido').val();
    window.open("xml_excel.php?psguia_numero_pedido=" + lsguia_numero_pedido);
});
