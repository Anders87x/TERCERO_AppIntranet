...
<head>
    ...
    <title><?php echo strtoupper($lsempresa_abreviatura)?> :: Tipo de estado</title>
</head>
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Tipo de estado</li>
			</ol>

            <h1 class="page-header">Tipo de estado <small></small></h1>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<h4 class="panel-title">TIPO DE ESTADO</h4>
    ...
    <?php require_once("arc_tipo_estado_mnto.php");?>
    <?php require_once("../NavJs/index.php");?>

	<script src="arc_tipo_estado.js"></script>
