<?php
	...
	require_once("../models/arc_tipo_servicio.php");
	$objservicio = new svrarc_tipo_servicio();
	...
	switch($_GET["caso"]){
		...
		case "ctrl_obtener_vista_00":
			...
			foreach ($obj_datos as $row) {
				...
				$sub_array[] = $row["stipo_servicio_descripcion"];
		...
		case "ctrl_agregar":
			$objservicio->mdl_agregar(
				...
				$_POST["pstipo_servicio_descripcion"],
